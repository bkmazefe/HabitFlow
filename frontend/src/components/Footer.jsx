...
export default function Footer({ t, onNavigate, currentPage }) {
  ...
  const handleSubscribe = async (e) => {
    ...
    try {
      ...
      // Optional: hide success message after 3s
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-xl text-[#543310] dark:text-white">
                HabitFlow
              </h3>
            </div>
            <p className="text-gray-600 dark:text-slate-400 text-sm leading-relaxed mb-5">
              {t?.footer?.aboutText ||
                "Build better habits and track your progress with our beautiful habit tracking app."}
            </p>
            {/* Social Links */}
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold text-[#543310] dark:text-white mb-4 text-sm uppercase tracking-wider">
